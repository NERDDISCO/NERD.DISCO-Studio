...
function ndAudio(args) {
  ...
  this.mediaElement_volume = args.mediaElement_volume || 1;
...
var ndMidi = (function () {
  ...
  _createClass(ndMidi, [{
    ...
    key: 'nonMusicalCommands',
    // / ndMidi.patchChange

    value: function nonMusicalCommands(args) {
      if (this.debug) {
...
var ndMidiTest = (function () {
  function ndMidiTest(args) {
    _classCallCheck(this, ndMidiTest);

    // Reference to ndMidi
    this.ndMidi = args.ndMidi || null;
  }

  _createClass(ndMidiTest, [{
    key: 'createMessage',
